...
type GopherClient interface {
	// Get Gopher URL
	GetGopher(ctx context.Context, in *GopherRequest, opts ...grpc.CallOption) (*GopherRequest, error)
}
...
func (c *gopherClient) GetGopher(ctx context.Context, in *GopherRequest, opts ...grpc.CallOption) (*GopherRequest, error) {
	out := new(GopherRequest)
...
type GopherServer interface {
	// Get Gopher URL
	GetGopher(context.Context, *GopherRequest) (*GopherRequest, error)
...
func (UnimplementedGopherServer) GetGopher(context.Context, *GopherRequest) (*GopherRequest, error) {
